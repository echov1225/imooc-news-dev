...
public class Swagger2 {
    ...
    //    http://localhost:port/swagger-ui.html     原路径
    //    http://localhost:port/doc.html            新路径
...
//        Predicate<RequestHandler> articlePredicate = RequestHandlerSelectors.basePackage("com.imooc.article.controller");
        Predicate<RequestHandler> userPredicate = RequestHandlerSelectors.basePackage("com.imooc.user.controller")::apply;
...
//                .apis(Predicates.or(userPredicate, adminPredicate, filesPredicate))
                .apis(Predicates.or(userPredicate::test))
